...
public class Network extends Thread {
    ...
    {	
    	...
    	while (true)
    	{
    		if (Network.getInBufferStatus().equals("empty") && Network.getOutBufferStatus().equals("empty") || (getInBufferStatus().equals("full") && Network.getOutBufferStatus().equals("full"))) {
    			Thread.yield();
    		}
